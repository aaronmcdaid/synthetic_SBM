...
const char *gengetopt_args_info_purpose = "Generate network data";

const char *gengetopt_args_info_usage = "Usage: synthetic data from the Stochastic Block Models [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -K, --K=INT     Number of clusters, K",
  "  -N, --N=INT     Number of nodes, N",
  "  -s, --seed=INT  Seed for srand48()",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->N_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->K_given)
    {
      fprintf (stderr, "%s: '--K' ('-K') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  
  if (! args_info->N_given)
    {
      fprintf (stderr, "%s: '--N' ('-N') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVK:N:s:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'K':	/* Number of clusters, K.  */
          ...
          if (update_arg( (void *)&(args_info->K_arg), 
              ...
              &(local_args_info.K_given), optarg, 0, 0, ARG_INT,
